...
// Initialize variables for further tasks
let Total = 0;
let changes = [];
...
// looking for the net total amount of Profit/Losses over the entire period and changes:

for (let i = 0; i < finances.length; i++) {
  //finances[i][1] refers to sums for each month
  Total += finances[i][1];

  if (i > 0) {
    //push - array method to add data to an end of the array
